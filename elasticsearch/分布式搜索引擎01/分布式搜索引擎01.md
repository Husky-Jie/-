...
[参考课前资料](D:\Java学习\java笔记\elasticsearch\安装elasticsearch)：
...
![image-20230323155045712](D:\Java学习\java笔记\elasticsearch\分布式搜索引擎01\assets\image-20230323155045712.png)
...
RestHighLevelClient client = new RestHighLevelClient(RestClient.builder(
        HttpHost.create("http://192.168.108.128:9200")
));
```
